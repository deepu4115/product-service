...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<ProductResponse> addProduct(@RequestBody @Valid ProductRequest productRequest, @RequestParam Long sellerId) {
    ...
    public ResponseEntity<ProductResponse> decrementStock(@PathVariable Long id, @RequestParam int quantity) {
        ProductResponse response = productService.decrementStock(id, quantity);
        return ResponseEntity.ok(response);
    }
